...
public class ListenerWD extends AbstractWebDriverEventListener {
    ...
    public void beforeGetText(WebElement element, WebDriver driver) {
        ...
        logger.info("get text from th element with text: "+element.getText());
    }
    ...
    public void beforeClickOn(WebElement element, WebDriver driver) {
        ...
        logger.info("start method click on:" + element);
    }
    ...
    public void afterScript(String script, WebDriver driver) {
        ...
        logger.info("script execute success: " +script);
    ...
    public void onException(Throwable throwable, WebDriver driver) {
        ...
        logger.info("Problem is detected");
